...
${PASSWORD}                           Password!
# Expected Values
${LABEL_ALERT_LOGIN_FAILED}           Your password is invalid!


*** Test Cases ***
TEST2 Login Failed - Password Incorrect
    [Documentation]    Owner : Tawan Duangchit
    ...    |    ***| Objective |***
    ...    |    To verify that users can login unsuccessfully when they input a correct username but wrong password.
    ...    ==>
